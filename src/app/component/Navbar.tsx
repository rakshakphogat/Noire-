...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full backdrop-blur-lg bg-white/90 dark:bg-gray-900/90 border-b border-gray-200/20 dark:border-gray-700/30 shadow-sm">
      ...
      <div className="relative w-full px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        {/* Logo Section */}
        <div className="flex items-center">
          <div
            className="cursor-pointer ml-6 flex items-center space-x-3"
        ...
        <div className="flex items-center gap-4 mr-6">
          ...
          {!searchOpen ? (
            <Button
              ...
              className="cursor-pointer relative text-gray-300 hover:bg-blue-50 dark:hover:bg-gray-800 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 rounded-xl"
            >
          ...
          {!isAuthenticated ? (
            <Button
              ...
              className="cursor-pointer relative text-gray-300 hover:bg-green-50 dark:hover:bg-gray-800 hover:text-green-600 dark:hover:text-green-400 transition-all duration-300 rounded-xl"
            >
          ...
          <div className="relative">
            <Button
              ...
              className="cursor-pointer relative text-gray-300 hover:bg-orange-50 dark:hover:bg-gray-800 hover:text-orange-600 dark:hover:text-orange-400 transition-all duration-300 rounded-xl"
            >
